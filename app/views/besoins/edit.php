    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-pencil me-2"></i>Modifier le Besoin
            </div>
            <div class="card-body">
                <form action="/besoins/update/<?= $besoin['id'] ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="type_article_id" name="type_article_id" required>
                            ...
                            <?php endif; ?>
                                <option value="<?= $type['id'] ?>" <?= $type['id'] == $besoin['type_article_id'] ? 'selected' : '' ?>>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="quantite_necessaire" name="quantite_necessaire" 
                               min="0.01" step="0.01" required value="<?= $besoin['quantite_necessaire'] ?>">
                    </div>
