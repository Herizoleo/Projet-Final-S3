...
CREATE TABLE IF NOT EXISTS villes (
    ...
    population_sinistree INT DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS besoins (
    ...
    quantite_necessaire DECIMAL(15,2) NOT NULL,
    ...
    FOREIGN KEY (type_article_id) REFERENCES types_articles(id) ON DELETE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS ventes (
    ...
    don_id INT NOT NULL,
    quantite DECIMAL(15,2) NOT NULL,
    prix_unitaire_original DECIMAL(15,2) NOT NULL,
